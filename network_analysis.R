...
# load database
int_db <- read_excel('Hedges_2024.xlsx') # Former "interaction_database"
...
set.seed(202)
id <- plot(g, edge.arrow.size=.2, vertex.color="gold", vertex.size=20, 
...
set.seed(5)
plot(ss, vertex.size=degin*2, edge.arrow.size=.30, edge.curved=0.25,
     vertex.label.cex=1, vertex.label.dist=1, layout=layout.gem)

set.seed(5)
plot(ss, vertex.size=degout*2, edge.arrow.size=.30, edge.curved=0.25,
     vertex.label.cex=1, vertex.label.dist=1, layout=layout.gem)

# set.seed(1984)
# plot(ss, vertex.size=degall*3, edge.arrow.size=.3, edge.curved=0.25,
